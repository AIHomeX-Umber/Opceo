...
// FilterBar — underline tab style + grid/list toggle.
// Sticky below LandingNav (top = 56px global nav + 64px landing nav = 120px).
...
export function FilterBar() {
  ...
  return (
    <div
      ...
      style={{ top: 120, padding: '0 clamp(24px, 5vw, 72px)' }}
      id="intel"
    >
      {/* Tabs */}
