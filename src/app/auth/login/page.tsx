    ...
    <div className="min-h-[calc(100vh-56px)] flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <div className="mb-8">
          ...
          <p className="text-sm text-white/50">Sign in to keep building.</p>
        </div>
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-2 px-4 py-2.5 border border-white/15 rounded-md text-sm text-white hover:bg-white/5 transition-colors mb-6"
        >
...
export default function LoginPage() {
  return (
    <Suspense fallback={<div className="min-h-[calc(100vh-56px)] flex items-center justify-center"><div className="text-white/30 text-sm">Loading…</div></div>}>
      <LoginForm />
    </Suspense>
  );
}
