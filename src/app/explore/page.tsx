...
export const metadata: Metadata = genMeta({
  ...
  description:
    'Discover builders shipping in public on Opeco.AI. Browse by build score, streak, and skills — then signal bet on the ones you believe in.',
  path: '/explore',
});
